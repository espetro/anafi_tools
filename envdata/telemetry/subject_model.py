...
class SubjectModel:
    ...
    def __init__(self, rad=0.6, height=1.7):
        """
        Setups a subject object model linked to the Gazebo model.

        :param pose_x:
        :param pose_y:
        :param pose_z:
        :param rad: Radius is checked by placing the subject in a cylinder in the simulation.
    ...
    def __repr__(self):
        return "(Subject ({},{},{}))".format(*self.get_pos())
